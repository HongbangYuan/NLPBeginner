...
if __name__ == '__main__':
    ...
    # url = "https://allnovel.net/romance.html?page=1"
    # novel_infos = get_novel_infos_by_page_english(url)

    # novel_name = "one-with-you-crossfire-5"
    # chapter_num = get_chapter_num_by_novel_name(novel_name)
    # output_dir = "english_novels"
    # scrape_by_novel_name_and_chapter_num_english(novel_name,chapter_num,output_dir)
